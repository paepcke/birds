...
""" Below from data_augmentation/src/WavSpoofer.py """
def add_background(file_name, noise_path, in_dir, out_dir, len_noise_to_add=5.0):
    """
...
def time_shift(file_name, in_dir, out_dir):
    """
...
def warp_spectrogram(file_name, in_dir, out_dir):
    """
