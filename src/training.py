...
class Training:
    def __init__(self, FILEPATH, EPOCHS = 60, SEED = 42, BATCH_SIZE = 32, KERNEL_SIZE = 5, NET_NAME = 'BasicNet', GPU = 1):
        ...
        #configure net
        self.model = getNet(NET_NAME, BATCH_SIZE, KERNEL_SIZE)
        self.train_data_loader, self.test_data_loader = self.importData(filepath)        
    ...
    def importData(self):
        ...
        test_data = torchvision.datasets.ImageFolder(root = filepath + "validation/", transform = transform_img)
